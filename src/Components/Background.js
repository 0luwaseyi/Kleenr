...
function Background(){
    ...
    return(
        <div className='background-content'>
            <div data-aos = "fade-right" data-aos-duration = "1500" className='left-content'>
               <h1>Fast, Reliable <br /> and Efficient</h1>
               <p>At Kliener, we are committed to giving you the best services<br /> you can think of
