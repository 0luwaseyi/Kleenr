    ...
    return(
        <div data-aos = "fade-up" data-aos-duration = "1300" className ="footer-content">
            ...
            <div className='footer-wrapper'>
                ...
                <p>
                     <br/>
                    46, Oba-Akran avenue, Ikeja,<br/> Lagos State.
                </p>

                <p>
                    <strong>Call us and hire us:</strong><br/>
                    Support@kleenteam.com
                </p>
            ...
            <div className='social-media'>
                <div className='facebook-logo'><a href='www.facebook.com'>
            ...
            <div className='policy-content'>
                ...
                <h3>Privacy and policy statement</h3>
            </div>
